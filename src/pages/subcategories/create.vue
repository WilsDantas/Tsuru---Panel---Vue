  ...
  <div>
    <ol class="breadcrumb bg-light">
      ...
      <li class="breadcrumb-item active" >
        <router-link :to="{name: 'subcategories.index'}">Category</router-link>
      </li>
      <li class="breadcrumb-item active" >
        <router-link :to="{name: 'subcategories.create'}">Register</router-link>
      </li>
    </ol>
    <div class="card-header">
      ...
      <div class="card">
        <div class="card-body">
          <form @submit.prevent="createSubCategory" class="form" method="POST" enctype="multipart/form-data">
            <div class="row">     
              ...
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <div class="text-danger" v-if="errors.category != undefined" >
                    {{this.errors.category[0]}}
                  </div>
                  <select class="form-control" v-model="formData.category" :class="{'error': errors.category}">
...
export default {
  ...
  methods: {
    createSubCategory() {
      this.loading = false;
      this.$store
        .dispatch("createSubCategory", this.formData)
        .then((response) => {
