<template>
  <div>
    <ol class="breadcrumb bg-light">
      ...
      <li class="breadcrumb-item active" >
        <router-link :to="{name: 'categories.create'}">Register</router-link>
      </li>
    </ol>
    <div class="card-header">
      ...
      <div class="card">
        <div class="card-body">
          <form @submit.prevent="createCategory" class="form" method="POST" enctype="multipart/form-data">
            <div class="row">     
...
export default {
  ...
  methods: {
    createCategory() {
      this.loading = false;
      this.$store
        .dispatch("createCategory", this.formData)
        .then((response) => {
